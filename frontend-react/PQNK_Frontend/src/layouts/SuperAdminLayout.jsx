...
const navItems = [
    ...
    { label: "User Registry", path: "/super-admin-dashboard/users", icon: "👥" },
...
function getInitials(name = "") {
    return name.split(" ").map(n => n[0]).slice(0, 2).join("").toUpperCase() || "SA";
}
...
export default function SuperAdminLayout({ children }) {
    ...
    let user = { name: "Super Admin", email: "", role: "superadmin" };
            ...
            <div className="flex-1 flex flex-col min-w-0 relative z-10">
                <div className="flex items-center justify-between px-8 py-3 bg-emerald-950/70 backdrop-blur-xl border-b border-white/10 flex-shrink-0">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div
                            className="w-8 h-8 rounded-full bg-gradient-to-br from-amber-400 to-yellow-500 text-emerald-950 flex items-center justify-center font-bold text-xs shadow-lg shadow-amber-400/20 cursor-pointer"
